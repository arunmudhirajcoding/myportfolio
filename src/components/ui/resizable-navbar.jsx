...
export const Navbar = ({
  ...
  return (
    <motion.div
      ...
      className={cn("sticky inset-x-0 top-0 z-40 w-full border-0", className)}>
...
export const NavbarLogo = () => {
  return (
    <a
      ...
      <h1 className="text-4xl bg-clip-text text-transparent bg-linear-to-b from-neutral-200 to-neutral-600  text-center font-sans font-bold">Arun kumar</h1>
    </a>
  );
};
