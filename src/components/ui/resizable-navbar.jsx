...
export const NavItems = ({ items, className, onItemClick }) => {
	...
	return (
		<motion.div
			...
			className={cn(
				"absolute inset-0 hidden md:inline-block flex-1 flex-row items-center justify-center space-x-2 text-sm font-bold transition duration-200 hover:text-zinc-800 lg:flex lg:space-x-2",
				className,
			)}
		>
			{items.map((item, idx) => (
...
export const NavbarLogo = () => {
	return (
		<a
			href="#Home"
			className="relative z-20 mr-4 flex items-center px-1 py-1 cursor-pointer"
		>
			<h1 className="text-5xl bg-clip-text text-transparent bg-linear-to-b from-neutral-200 to-neutral-600  text-center font-sans font-bold">
				Arun kumar
			</h1>
		</a>
	);
