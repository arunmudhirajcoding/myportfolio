...
const certificates = [
	{
		...
		credentialId: "",
		credentialUrl:
			"https://drive.google.com/file/d/1Xth6QtpJ7tdOdZswqwdQ72GB3tiLzD9Z/view?usp=sharing",
	},
	{
		id: 2,
		...
		credentialUrl:
			"https://drive.google.com/file/d/1OyJ8MTewdzMOE_LPbUyv_Lx7COobqYYy/view?usp=sharing",
	},
	{
		id: 3,
		...
		credentialUrl:
			"https://drive.google.com/file/d/1VED77NWaQCtQdz7BIb0bLC0cjZNeNsWT/view?usp=sharing",
	},
	{
		id: 4,
		...
		credentialUrl:
			"https://drive.google.com/file/d/1m6B8UNYqPf8Y0x6r24h9BWufwtFhzCFB/view?usp=sharing",
	},
	{
		id: 5,
		...
		credentialId: "",
		credentialUrl:
			"https://drive.google.com/file/d/1s5Z_bmmB9usQiRtA86mODw79vs0L9-BG/view?usp=sharing",
	},
	{
		id: 6,
		...
		credentialUrl:
			"https://drive.google.com/file/d/1cMPsjKz8pfCn3echyVAu5DMmJ367CanA/view?usp=sharing",
	},
];
			...
			<div className="group relative h-full overflow-hidden rounded-2xl border border-zinc-200 bg-white transition-all duration-300 hover:-translate-y-1 hover:shadow-xl border-zinc-800 bg-zinc-950">
				<div className="relative aspect-16/10 w-full overflow-hidden rounded-tl-2xl rounded-tr-2xl bg-zinc-100 bg-zinc-900">
					<Image
						...
						className="object-cover transition duration-300 group-hover:scale-95 group-hover:rounded-2xl"
					/>
